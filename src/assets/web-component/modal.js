class Modal extends HTMLElement {
    constructor() {
        ...
        const btnCancel = document.createElement('tou-button');
        const btnOk = document.createElement('tou-button');

        // wrap
        wrap.setAttribute('class', 'wrap');

        // modal
        modal.setAttribute('class', 'tou-modal');
        let title = this.getAttribute('title');
        header.textContent = title;
        btnClose.setAttribute('class', 'tou-close');
...
customElements.define('tou-modal', Modal);